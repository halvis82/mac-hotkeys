...
How each part works and why, most of it learned the hard way. Worth reading before changing
anything; the README covers using it.
...
## The moon key: reading the current Focus
...
| "Moon Key Off" pinned to a specific Focus | "Off" would not clear Sleep, Work, Personal and so on. The Shortcut needs a plain "Turn Focus Off" |

## The moon key: if it misbehaves
